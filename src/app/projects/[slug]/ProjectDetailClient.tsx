...
export default function ProjectDetailClient({ project }: { project: Project | undefined }) {
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <div className="glass-card rounded-3xl p-8 md:p-12">
              ...
              {/* Project Image */}
              <div className="aspect-video bg-gradient-to-br from-blue-200/50 to-sky-200/50 dark:from-blue-900/30 dark:to-sky-900/30 rounded-2xl mb-8 flex items-center justify-center overflow-hidden relative">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
