...
export const allProjects: Project[] = [
  ...
  },
  {
    id: 'math24',
    title: 'MATH24',
    description: 'Mathematical puzzle game combining four numbers to reach 24 using arithmetic.',
    longDescription: 'Classic mathematical puzzle game where players use four numbers and basic arithmetic operations to create expressions equaling 24. Designed to improve mental math skills and problem-solving abilities through engaging gameplay.',
    image: '/project-math24.jpg',
    tags: ['Python', 'Game', 'Education'],
    link: '#',
    category: 'project',
    features: [
    ...
    technologies: ['Python', 'Algorithm Design', 'Game Logic', 'CLI'],
  },
  {
    id: 'zkcert',
    title: 'ZKcert',
