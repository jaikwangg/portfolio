        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#projects"
              className="border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black px-8 py-4 hover:bg-white dark:hover:bg-gray-900 hover:text-black dark:hover:text-white transition-all duration-300"
            >
              View My Work
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="border-2 border-black dark:border-white text-black dark:text-white px-8 py-4 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black transition-all duration-300"
            >
              Contact Me
            </motion.a>
          </motion.div>
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="w-12 h-12 border-2 border-black dark:border-white rounded-full flex items-center justify-center hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black transition-all duration-300"
              aria-label="GitHub"
            >
              <svg
                className="w-6 h-6"
