      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          <motion.div
            ...
            className="mb-8"
          >
            <div className="w-24 h-24 mx-auto border-2 border-black rounded-full flex items-center justify-center">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#projects"
              className="border-2 border-black bg-black text-white px-8 py-4 rounded-none font-medium hover:bg-white hover:text-black transition-all duration-300"
            >
              View My Work
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="border-2 border-black text-black px-8 py-4 rounded-none font-medium hover:bg-black hover:text-white transition-all duration-300"
            >
              Contact Me
            </motion.a>
          </motion.div>
