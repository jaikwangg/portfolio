      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="aspect-video border-2 border-black bg-gray-50 relative overflow-hidden">
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, tagIndex) => (
                    <span
                      key={tagIndex}
                      className="px-3 py-1 text-sm border border-black text-black"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  href={project.link}
                  className="inline-block border-2 border-black text-black px-6 py-2 hover:bg-black hover:text-white transition-all duration-300"
                >
                  View Project
                </motion.a>
              </div>
